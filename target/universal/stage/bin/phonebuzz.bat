@REM phonebuzz launcher script
@REM
@REM Environment:
@REM JAVA_HOME - location of a JDK home dir (optional if java on path)
@REM CFG_OPTS  - JVM options (optional)
@REM Configuration:
@REM PHONEBUZZ_config.txt found in the PHONEBUZZ_HOME.
@setlocal enabledelayedexpansion

@echo off

if "%PHONEBUZZ_HOME%"=="" set "PHONEBUZZ_HOME=%~dp0\\.."

set "APP_LIB_DIR=%PHONEBUZZ_HOME%\lib\"
...
set "CFG_FILE=%PHONEBUZZ_HOME%\PHONEBUZZ_config.txt"
set CFG_OPTS=
if exist "%CFG_FILE%" (
...
if "%JAVAOK%"=="false" (
  ...
  echo and download a valid Java JDK and install before running phonebuzz.
  echo.
...
"%_JAVACMD%" !_JAVA_OPTS! !PHONEBUZZ_OPTS! -cp "%APP_CLASSPATH%" %MAIN_CLASS% !_APP_ARGS!
